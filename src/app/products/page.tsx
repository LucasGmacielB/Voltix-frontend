      ...
      <section className="relative min-h-[42vh] bg-gradient-to-br from-black via-zinc-950 to-zinc-900 px-6 py-6 text-white">
        ...
        <div className="mx-auto mt-8 flex max-w-6xl flex-col items-center text-center">
          ...
          <div className="mt-6 flex w-full max-w-2xl flex-col gap-3 sm:flex-row">
            ...
            <Link
              href="/categories"
              className="inline-flex items-center justify-center rounded-lg bg-green-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:bg-green-500"
            >
